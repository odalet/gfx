...
public class TeapotControl2 : OpenGlControlBaseCopy
{
    ...
    static TeapotControl2() => AffectsRender<TeapotControl2>(YawProperty, PitchProperty, RollProperty, DiscoProperty);

    public TeapotControl2()
    {
        var name = typeof(TeapotControl2).Assembly.GetManifestResourceNames().First(x => x.Contains("teapot.bin"));
        var stream = typeof(TeapotControl2).Assembly.GetManifestResourceStream(name);
        if (stream == null)
        {
    ...
    public static readonly DirectProperty<TeapotControl2, float> YawProperty =
        AvaloniaProperty.RegisterDirect<TeapotControl2, float>(nameof(Yaw), o => o.Yaw, (o, v) => o.Yaw = v);
    ...
    public static readonly DirectProperty<TeapotControl2, float> PitchProperty =
        AvaloniaProperty.RegisterDirect<TeapotControl2, float>(nameof(Pitch), o => o.Pitch, (o, v) => o.Pitch = v);
    ...
    public static readonly DirectProperty<TeapotControl2, float> RollProperty =
        AvaloniaProperty.RegisterDirect<TeapotControl2, float>(nameof(Roll), o => o.Roll, (o, v) => o.Roll = v);
    ...
    public static readonly DirectProperty<TeapotControl2, float> DiscoProperty =
        AvaloniaProperty.RegisterDirect<TeapotControl2, float>(nameof(Disco), o => o.Disco, (o, v) => o.Disco = v);
    ...
    public static readonly DirectProperty<TeapotControl2, string> InfoProperty = AvaloniaProperty.RegisterDirect<TeapotControl2, string>(
...
");
    ...
    protected override unsafe void OnOpenGlInit(GlInterface glInterface, int fb)
    {
        glInstance = new GL(glInterface.GetProcAddress);
        var gl = glInstance!;
        ...
        LogError(vertexLog ?? "Vertex Shader Compilation failed");

        // Load the source of the fragment shader and compile it.
        fragmentShader = gl.CreateShader(ShaderType.FragmentShader);
        var fragmentLog = gl.CompileShaderAndGetError(fragmentShader, FragmentShaderSource);
        LogError(fragmentLog ?? "Fragment Shader Compilation failed");
        ...
        LogError(programLog ?? "Shader Program Compilation failed");
        CheckGLError(gl);
    ...
    protected override void OnOpenGlDeinit(GlInterface glInterface, int fb)
    {
        var gl = glInstance!;
