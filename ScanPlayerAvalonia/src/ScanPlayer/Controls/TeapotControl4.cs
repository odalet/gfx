...
public class TeapotControl4 : GLSurface
{
    ...
    static TeapotControl4() => AffectsRender<TeapotControl4>(YawProperty, PitchProperty, RollProperty, DiscoProperty);

    public TeapotControl4()
    {
        var name = typeof(TeapotControl4).Assembly.GetManifestResourceNames().First(x => x.Contains("teapot.bin"));
        var stream = typeof(TeapotControl4).Assembly.GetManifestResourceStream(name);
        if (stream == null)
        {
    ...
    public static readonly DirectProperty<TeapotControl4, float> YawProperty =
        AvaloniaProperty.RegisterDirect<TeapotControl4, float>(nameof(Yaw), o => o.Yaw, (o, v) => o.Yaw = v);
    ...
    public static readonly DirectProperty<TeapotControl4, float> PitchProperty =
        AvaloniaProperty.RegisterDirect<TeapotControl4, float>(nameof(Pitch), o => o.Pitch, (o, v) => o.Pitch = v);
    ...
    public static readonly DirectProperty<TeapotControl4, float> RollProperty =
        AvaloniaProperty.RegisterDirect<TeapotControl4, float>(nameof(Roll), o => o.Roll, (o, v) => o.Roll = v);
    ...
    public static readonly DirectProperty<TeapotControl4, float> DiscoProperty =
        AvaloniaProperty.RegisterDirect<TeapotControl4, float>(nameof(Disco), o => o.Disco, (o, v) => o.Disco = v);
    ...
    public static readonly DirectProperty<TeapotControl4, string> InfoProperty = AvaloniaProperty.RegisterDirect<TeapotControl4, string>(
...
");
    ...
    protected override unsafe void OnRender(GL gl, uint fb)
    {
        ...
        //view = Matrix4x4.CreateLookAt(Vector3.Zero, Vector3.UnitZ, Vector3.UnitY);
    ...
    private static void Draw(GL gl)
    {
        const double z = 0.0;
        var length = 10f; // 0.2 / ScalingRatio;
