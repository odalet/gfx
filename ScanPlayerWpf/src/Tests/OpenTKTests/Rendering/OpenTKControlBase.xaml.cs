...
{
    // Adapted from https://github.com/jayhf/OpenTKControlBase
    public partial class OpenTKControlBase : UserControl
    {
        ...
        public static readonly DependencyProperty ContinuousProperty = DependencyProperty.Register(
                nameof(Continuous), typeof(bool), typeof(OpenTKControlBase), new PropertyMetadata(true));
        ...
        private void InitializeDependencyProperties()
        {
            ...
            DependencyPropertyDescriptor.FromProperty(OpenGLVersionProperty, typeof(OpenTKControlBase)).AddValueChanged(this,
                (s, e) => volatileOpenGLVersion = OpenGLVersion);

            DependencyPropertyDescriptor.FromProperty(FrameRateLimitProperty, typeof(OpenTKControlBase)).AddValueChanged(this,
                (s, e) => volatileFrameRateLimit = FrameRateLimit);

            DependencyPropertyDescriptor.FromProperty(PixelScaleProperty, typeof(OpenTKControlBase)).AddValueChanged(this,
                (s, e) => volatilePixelScale = PixelScale);

            DependencyPropertyDescriptor.FromProperty(MaxPixelsProperty, typeof(OpenTKControlBase)).AddValueChanged(this,
                (s, e) => volatileMaxPixels = MaxPixels);

            DependencyPropertyDescriptor.FromProperty(ContinuousProperty, typeof(OpenTKControlBase)).AddValueChanged(this, (s, e) =>
            {
